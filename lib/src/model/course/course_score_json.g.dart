...
CourseScoreCreditJson _$CourseScoreCreditJsonFromJson(Map<String, dynamic> json) {
...
SemesterCourseScoreJson _$SemesterCourseScoreJsonFromJson(Map<String, dynamic> json) {
